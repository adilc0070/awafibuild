...
class BannerController {
    bannerInteractor;
    constructor(bannerInteractor) {
        this.bannerInteractor = bannerInteractor;
    }
    async addOfferBanner(req, res, next) {
        try {
    ...
    async unlistBanner(req, res, next) {
        try {
    ...
    async welcomeBanners(req, res, next) {
        try {
    ...
    async offerBanners(req, res, next) {
        try {
    ...
    async collectionBanners(req, res, next) {
        try {
